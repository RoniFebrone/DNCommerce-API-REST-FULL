...
const Cliente = require('../../models/Clientes/clientes')(sequelize);
const PedidoProduto = require('../../models/Pedido_Produto/pedido_produto')(sequelize);
const Produto = require('../../models/Produtos/produtos')(sequelize);
