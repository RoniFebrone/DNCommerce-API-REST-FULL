...
const Vendas = require('../../models/Vendas/vendas')(sequelize);
const Pedidos = require('../../models/Pedidos/pedidos')(sequelize);
const Produtos = require('../../models/Produtos/produtos')(sequelize);
const Pedido_Produto = require('../../models/Pedido_Produto/pedido_produto')(sequelize, Produtos);
const Estoque = require('../../models/Estoque/estoque')(sequelize);
